            ...
            if let Instruction::IntCompare { dst, a, pred, b } = instruction {
                ...
                for _ in 0..2 {
                    ...
                    if let (Some(Instruction::Select { cond, on_true, on_false, .. }),
                        ...
                        // If select true value is the same as false value then select instruction
                        // can be optimized out. Other optimization pass will take care of it.
                        if on_true == on_false {
                            return;
                        }
                        ...
                        if let Some(inverted) = result {
                            if !inverted {
                                    ...
                                    = parent_compare
                                {
                                    ...
                                    // Change this instruction to inverted version of first icmp.
