...
impl FunctionData {
    ...
    fn rewrite_values(&mut self) {
        ...
        for &undefined in &self.undefined_set {
        ...
        self.for_each_instruction_mut(|_location, instruction| {
        ...
        // Update undefined values.
        {
            ...
            for value in self.undefined.values_mut() {
        ...
        self.next_value = values.next_value;

        // Update function type information.
        self.type_info = self.type_info.take().map(|old_type_info| {
        ...
        assert!(self.phi_locations.is_empty(), "PHI locations map wasn't empty during rewrite.");
    }
